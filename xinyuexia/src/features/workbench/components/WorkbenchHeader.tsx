...
export function WorkbenchHeader({
  ...
  const navItems = [
    { label: '提炼剧情', icon: Sparkles, onClick: onOpenExtract },
    { label: '设定库', icon: Database, onClick: onOpenSettings },
    { label: '概要库', icon: BookMarked, onClick: onOpenOutline },
    { label: '备忘录', icon: StickyNote, onClick: onOpenNotes },
  ];
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-full bg-brand px-3 py-1.5 text-sm font-medium text-white transition-colors hover:bg-brand-dark"
          >
